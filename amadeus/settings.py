...
DATABASES = {
    'default': {
        ...
        #'USER': 'amadeus',                      # Not used with sqlite3.
        #'PASSWORD': 'amadeus',                  # Not used with sqlite3.
...
SECRET_KEY = '=1q=ttbj6+yd@u656ag@y&amp;%^a=@k+#!f(2bh_6(r@r@w+5!h^1'
...
#EMAIL 
DEFAULT_FROM_EMAIL = 'contato@amadeus.br'
# Por enquanto, o email nao vai ser enviado, so vai ser "impresso" no console.
